...
//$oDocumento->ValidaNivelUsuario("documento");
...
<script type="text/javascript">
    ...
    function Listado() {
        ...
        $.ajax({
            data: jsonDatos,
            type: "POST",
            url: "app/views/default/modules/catalogos/documento/m.documento.listado.php",
            beforeSend: function() {
                $("#divListado").html(
    ...
    function Editar(id, nombre) {
        if (nombre == "Desactivar") {
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/documento/m.documento.procesa.php",
                beforeSend: function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/documento/m.documento.formulario.php",
                beforeSend: function() {
                    $("#divFormulario").html(
