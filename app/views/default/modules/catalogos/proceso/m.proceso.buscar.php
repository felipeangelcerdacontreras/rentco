...
<script type="text/javascript">
    ...
    function Listado() {
        ...
        $.ajax({
            data: jsonDatos,
            type: "POST",
            url: "app/views/default/modules/catalogos/proceso/m.proceso.listado.php",
            beforeSend: function() {
                $("#divListado").html(
    ...
    function Editar(id, nombre) {
        if (nombre == "Desactivar") {
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/proceso/m.proceso.procesa.php",
                beforeSend: function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/proceso/m.proceso.formulario.php",
                beforeSend: function() {
                    $("#divFormulario").html(
