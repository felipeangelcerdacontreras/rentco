...
<script type="text/javascript">
    ...
    function Listado() {
        ...
        $.ajax({
            data: jsonDatos,
            type: "POST",
            url: "app/views/default/modules/catalogos/estatus_documento/m.estatus_documento.listado.php",
            beforeSend: function() {
                $("#divListado").html(
    ...
    function Editar(id, nombre) {
        if (nombre == "Desactivar") {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/estatus_documento/m.estatus_documento.formulario.php",
                beforeSend: function() {
                    $("#divFormulario").html(
