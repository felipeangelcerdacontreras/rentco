...
<script type="text/javascript">
    ...
    function Listado() {
        ...
        $.ajax({
            data: jsonDatos,
            type: "POST",
            url: "app/views/default/modules/catalogos/permisos/m.permisos.listado.php",
            beforeSend: function() {
                $("#divListado").html(
    ...
    function Editar(id, nombre) {
        if (nombre == "Desactivar") {
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/permisos/m.permisos.procesa.php",
                beforeSend: function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "app/views/default/modules/catalogos/permisos/m.permisos.formulario.php",
                beforeSend: function() {
                    $("#divFormulario").html(
