...
<!DOCTYPE html PUBLIC>
<html>
<title>Bienvenid@/PROGRAMA DE ENTRENAMIENTO Y CAPACITACION PARA PERSONAL INDIRECTO</title>
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 40rem;"
                                        src="app/views/default/img/rentco.png" alt=""><br>
                                    <strong>RENTCO, S.A. DE C.V. </strong>
                                </div>
                            </div>
                        </div>
                        <?php $lstValuadores;?>
